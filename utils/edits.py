...
class EditTagger:
    ...
    def get_edits(self, source, target, add_special_tokens=True, max_len=128):
        ...
        for tag, i1, i2, j1, j2 in diffs:
            # print("DIFFERENCE 11", source_tokens)
            # print("DIFFERENCE 22", target_tokens)
            source_part = source_tokens[i1:i2]
            target_part = target_tokens[j1:j2]
            # print("DIFFERENCE 1", source_part)
            # print("DIFFERENCE 2", target_part)
            # print("DIFFERENCE 3", tag)
            # print("DIFFERENCE 4", i1, i2, j1, j2)
            if tag == 'equal':
                continue
            elif tag == 'delete':
